  ...
  return (
    <div className="mx-auto flex flex-col gap-3 p-3 pt-12">
      ...
      <div className="grid gap-2 rounded-xl border border-[#e5e5e5] bg-white p-4 shadow-sm lg:grid-cols-[2fr_1fr]">
        ...
        <div className="flex items-center justify-between w-full rounded-xl border border-[#e5e5e5] bg-white p-4 text-sm text-[#404040] shadow-sm">
          ...
          <div className="flex items-center justify-between gap-6 border-t border-[#ededed]">
            <span className="text-[#555555]">Выручка:</span>
            <span className="text-[16px] font-bold text-[#4e79a7]">
              {stats.total.toLocaleString("ru-RU", { minimumFractionDigits: 2 })} <span className="text-[#4e79a7]">руб.</span>
            </span>
          </div>
        </div>
      </div>
